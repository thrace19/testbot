const Discord = require('discord.js'), // This will be used for creating embed
 ...
 let  send = require('quick.hook'); // This will be used for creating & sending webhooks
...
if (!message.content.startsWith(botconfig.prefix)) return; 
  ...
  // Be sure to call this in async, as we will be fetching the invites of the guild
    ...
    let invites = await message.user.fetchInvites().catch(error => { // This will store all of the invites into the variable
